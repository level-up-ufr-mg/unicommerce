...
import br.com.alura.util.Endereco.Descontos;
...
public class Pedido {
	...
	public Pedido(@Valid DadosCadastroPedidosDTO dados, Cliente clienteDePedido, Produto produtoDePedido) {
		this.data = dados.data();
		this.desconto = dados.desconto();
		this.cliente = clienteDePedido;
